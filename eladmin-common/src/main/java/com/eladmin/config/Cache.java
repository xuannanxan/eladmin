...
public class Cache extends JsonPropertyObject {
    ...
    public static class Redis extends JsonPropertyObject {
    ...
    public static class Ehcache extends JsonPropertyObject {
        private static final long serialVersionUID = 1L;
        public static final Boolean DEFAULT_JMXENABLE = false;
